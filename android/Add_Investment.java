...
public class Add_Other_Sale extends AppCompatActivity {
...
//            startActivity(i);
    ...
    public class Work_Save_Task extends AsyncTask<Void, Void, String[]> {
        ...
        Work_Save_Task(String description, Double amount) {
        ...
        protected String[] doInBackground(Void... params) {
            try {
                ...
                http_post = new HttpPost(General_Data.SERVER_IP_ADDRESS + "/android/add_investment.php");
                name_pair_value = new ArrayList<NameValuePair>(2);
